...
class Program
{
    ...
    static void CalculatePercentsByCountry(Survey[] survery)
    {
        ...
        for (int i = 0; i < animalAnswersAsArray.Length / 2; i++)
        {
            var temp = animalAnswersAsArray[i];
            animalAnswersAsArray[i] = animalAnswersAsArray[animalAnswersAsArray.Length - 1 - i];
            animalAnswersAsArray[animalAnswersAsArray.Length - 1 - i] = temp;
        }
        ...
        for (int i = 0; i < charAnswersAsArray.Length / 2; i++)
        {
            var temp = charAnswersAsArray[i];
            charAnswersAsArray[i] = charAnswersAsArray[charAnswersAsArray.Length - 1 - i];
            charAnswersAsArray[charAnswersAsArray.Length - 1 - i] = temp;
        }
        ...
        for (int i = 0; i < thingAnswersAsArray.Length / 2; i++)
        {
            var temp = thingAnswersAsArray[i];
            thingAnswersAsArray[i] = thingAnswersAsArray[thingAnswersAsArray.Length - 1 - i];
            thingAnswersAsArray[thingAnswersAsArray.Length - 1 - i] = temp;
        }
